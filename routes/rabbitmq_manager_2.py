...
# import zipfile
# from notification.firebase_utils import initialize_firebase, send_push_notification
# from agentic_system.agent import analyze_log_and_generate_summary
...
#     async def download_and_extract_log(self, url: str) -> str:
...
#             if 'openlane.log' in z.namelist():
#                 with z.open('openlane.log') as log_file:
#                     return log_file.read().decode('utf-8')
#         raise Exception("openlane.log file not found in the zip archive")
...
#                     log_content = await self.download_and_extract_log(msg_body['url'])

#                     # Analyze log and generate summary
#                     log_summary = analyze_log_and_generate_summary(log_content)

#                     notification_title = "Verilog Processing Update"
#                     notification_body = (
#                         f"Status - {msg_body['status']}, Log Summary - {log_summary}"
#                     )
#                     try:
#                         send_push_notification(fcm_token, notification_title, notification_body)
#                         logger.info("Push notification sent successfully.")
...
#-------------------------------------Log extraction and summarization-------------------------------------------
...
# import asyncio
# import logging
# from agent import analyze_log_and_generate_summary  # Import the function to analyze log and generate summary
...
#                     # Send log summary to the agent system
#                     await send_to_agent_system(log_summary)
