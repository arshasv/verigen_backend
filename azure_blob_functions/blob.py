...
if not connection_string:
    raise ValueError(
        "Azure Storage Connection String not found. Please check your .env file."
    )

if (
    "DefaultEndpointsProtocol" not in connection_string
    or "AccountName" not in connection_string
):
    raise ValueError(
        "Invalid connection string format. Please check your connection string in .env file."
    )
